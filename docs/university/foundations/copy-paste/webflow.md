...
| List Item        | ✅          |                                                                                                                                                                                                                        |
| Link Block       | ✅          |                                                                                                                                                                                                                        |
| Button           | ✅          | Maps to “[Link](../../core-components/link.md)”. [Buttons](/broken/pages/3eZsbLZWmonl2Bv3CJyC) are for interactions, like submitting a form, not linking.                                                              |
| Heading          | ✅          |                                                                                                                                                                                                                        |
| Paragraph        | ✅          |                                                                                                                                                                                                                        |
| Text Link        | ✅          |                                                                                                                                                                                                                        |
| Text Block       | ✅          |                                                                                                                                                                                                                        |
...
| Collection List  | ❌          | Though Webstudio does have a “[Collection](/broken/pages/pauhKZIgEF1NC1u9qwLe)” component.                                                                                                                             |
| Image            | ✅          |                                                                                                                                                                                                                        |
...
| Form Button      | ✅          | Maps to “[Button](/broken/pages/3eZsbLZWmonl2Bv3CJyC)”                                                                                                                                                                 |
| Search           | ❌          |                                                                                                                                                                                                                        |
| Background Video | ❌          |                                                                                                                                                                                                                        |
...
| Lightbox         | ❌          |                                                                                                                                                                                                                        |
| Locales List     | ❌          |                                                                                                                                                                                                                        |
| Navbar           | ✅          | Generates the corresponding components such as [Boxes](/broken/pages/J1vuJ2d8twUqPm14bKDs) and [Links](../../core-components/link.md) with [Tokens](../design-tokens.md) and styles.                                   |
