...
| Size           | Kebab  | `button-x-small\|small\|medium\|large`         | Appending a size modifier to the end of a Token. “T-shirt” sizing is the accepted naming convention.                                                                                                                                                                                      | Do we allow abbreviations here? “x” for extra but what about the others?                                                                                                                                                 |
