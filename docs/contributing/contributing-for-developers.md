...
3.  Set up the PostgreSQL database:
    ...
    * In `packages/prisma-client` set the connection values for the db in a `.env` file:
    ...
    * In the same directory run the following command to create the database schema:
